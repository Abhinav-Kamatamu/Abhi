...
class board():
    def draw(self):
        ...
        if colt == 'normal':
            ...
            yellow = pygame.draw.rect(win,co('yellow'),(((w-0.35*w)-0.1*w,(h-0.35*h)-0.1*h),(0.35*w,0.35*h)))
        ...
        if colt == 'blue':
            ...
            yellow = pygame.draw.rect(win,co('yellow'),(((w-0.35*w)-0.1*w,(h-0.35*h)-0.1*h),(0.35*w,0.35*h)))
            o_blue = pygame.draw.rect(win,(0,0,0),((0.1*w,(h-0.35*h)-0.1*h),(0.35*w,0.35*h)),int(0.35*w*0.03))
        ...
        if colt == 'green':
            ...
            blue    = pygame.draw.rect(win,co('blue'),((0.1*w,(h-0.35*h)-0.1*h),(0.35*w,0.35*h)))
            yellow  = pygame.draw.rect(win,co('yellow'),(((w-0.35*w)-0.1*w,(h-0.35*h)-0.1*h),(0.35*w,0.35*h)))
            o_green = pygame.draw.rect(win,(0,0,0),(((w-0.35*w)-0.1*w,0.1*h),(0.35*w,0.35*h)),int(0.35*w*0.03))
            
        if colt == 'yellow':
            red      = pygame.draw.rect(win,co('red'),((0.1*w,0.1*h),(0.35*w,0.35*h)))
            green    = pygame.draw.rect(win,co('green'),(((w-0.35*w)-0.1*w,0.1*h),(0.35*w,0.35*h)))
            blue     = pygame.draw.rect(win,co('blue'),((0.1*w,(h-0.35*h)-0.1*h),(0.35*w,0.35*h)))
            yellow   = pygame.draw.rect(win,co('d_yellow'),(((w-0.35*w)-0.1*w,(h-0.35*h)-0.1*h),(0.35*w,0.35*h)))
            d_yellow = pygame.draw.rect(win,(0,0,0),(((w-0.35*w)-0.1*w,(h-0.35*h)-0.1*h),(0.35*w,0.35*h)),int(0.35*w*0.03))
