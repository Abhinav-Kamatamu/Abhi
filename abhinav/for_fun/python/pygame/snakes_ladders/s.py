...
while go:
    ...
    if a == 100:
        ...
        text = font.render('{} has won the game'.format(name), True, (0, 0, 0), (255, 255, 255))
    ...
    if b == 100:
        ...
        p1_win = name, 'has won'
        font = pygame.font.Font('freesansbold.ttf', 30)
        text = font.render('{} has won the game'.format(name_2), True, (0, 0, 0), (255, 255, 255))
        textrect = text.get_rect()
        textrect.center = (w / 2, h / 2)
        win.blit(text, textrect)
        pygame.display.update()
...
great = font_2.render('Abhinav wrote the whole program on his own', True, (0, 0, 0), (255, 255, 255))
